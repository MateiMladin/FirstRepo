...
{
    static const touchgfx::FontId DEFAULT = 0;       // arialbd_23_4bpp
    static const touchgfx::FontId LARGE = 1;         // arialbd_60_4bpp
    static const touchgfx::FontId SMALL = 2;         // verdana_10_4bpp
    static const touchgfx::FontId TYPOGRAPHY_00 = 3; // arialbd_35_4bpp
