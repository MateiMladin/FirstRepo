...
KEEP extern const touchgfx::KerningNode kerning_arialbd_60_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x0059, -7 },  // (First char = [0x0059, Y], Second char = [0x002C, ,], Kerning dist = -7)
    ...
    { 0x0031, -3 },  // (First char = [0x0031, 1], Second char = [0x0031, 1], Kerning dist = -3)
    ...
    { 0x0041, -6 },  // (First char = [0x0041, A], Second char = [0x0059, Y], Kerning dist = -6)
